    ...
    React.createElement(Page, { size: "A4", style: styles.page },
      ...
      React.createElement(View, { style: styles.clientSection },
        ...
        React.createElement(View, { style: styles.clientLayout },
          ...
          React.createElement(View, { style: styles.clientMiddle },
            invoiceData.clientEmail && React.createElement(View, { style: styles.clientContact },
              React.createElement(Text, null, `📧 ${invoiceData.clientEmail}`)
            ),
            invoiceData.clientPhone && React.createElement(View, { style: styles.clientContact },
              React.createElement(Text, null, `📞 ${invoiceData.clientPhone}`)
            )
          ),
          
          // Right Column - Address
          React.createElement(View, { style: styles.clientRight },
            invoiceData.clientAddress && React.createElement(View, { style: styles.clientAddress },
              React.createElement(Text, null, `📍 ${invoiceData.clientAddress}`)
            )
          )
        )
      ),
...
module.exports = InvoicePDFTemplate;
